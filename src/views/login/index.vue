    ...
    <div class="login-form">
      <el-form ref="loginFormRef" :model="loginData" :rules="loginRules">
          ...
          <el-dropdown style="position: absolute; right: 0">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item @click="setLoginCredentials('root', 'password')">
                  超级管理员：root/123456
                </el-dropdown-item>
                <el-dropdown-item @click="setLoginCredentials('admin', 'password')">
                  系统管理员：admin/123456
                </el-dropdown-item>
                <el-dropdown-item @click="setLoginCredentials('test', 'password')">
                  测试小游客：test/123456
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
        ...
        <el-form-item prop="username">
          <div class="input-wrapper">
            <svg-icon icon-class="captcha" class="mx-2" />
            <el-input ref="authentication_code" v-model="loginData.authentication_code"
              :placeholder="$t('login.authentication_code')" name="authentication_code" size="large" class="h-[48px]" />
          </div>
        </el-form-item>
